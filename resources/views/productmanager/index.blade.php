...
@foreach($products as $product)
	...
	<div class="row productmanager" style="margin-top:70px;">
			<img class="col-xs-12 col-md-3 img-responsive" src="http://54.149.181.47/etnoc/{{$product->main_image}}">
			<div class="col-xs-12 col-md-8" style="color:#000;">
				...
				<div class="col-xs-12 col-md-6"> 
					<div style="border-radius:10px;background-color:#fff;height:600px;width:100%">
